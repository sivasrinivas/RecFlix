...
public class MahoutUserBasedRecommender implements Recommender {
           ...
           */
          public MahoutUserBasedRecommender() throws IOException, TasteException {
           ...
           * @throws TasteException if an error occurs while initializing this {@link GroupLensRecommender}
           */
          public MahoutUserBasedRecommender(DataModel model) throws TasteException {
