...
public class MahoutItemBasedRecommender implements Recommender {
                   ...
                   */
                  public MahoutItemBasedRecommender() throws IOException, TasteException {
                   ...
                   * @throws TasteException if an error occurs while initializing this {@link GroupLensRecommender}
                   */
                  public MahoutItemBasedRecommender(DataModel dataModel) throws TasteException {
                          Collection<GenericItemSimilarity.ItemItemSimilarity> correlations = MovieItemSimilarity.getAllMovieSimilarities();
